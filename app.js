...
const questions = [
  ...
  { question: "사람과 갈등에 처한 사람을 볼 때 당신은?", options: ["경청하며 위로한다", "같이 화를 내준다", "해결책을 제시한다", "상대방의 입장도 생각해보며 객관성을 유지한다"] },
  { question: "당신이 남들과 공유하고싶지 않은 감정은?", options: ["슬픔", "분노", "죄책감", "무기력"] },
  { question: "무기력에 빠진 주변 사람을 볼 때 당신은", options: ["그동안 너무 열심히 일했으니 쉴 자격이 있어!", "당장 약속을 잡고 수다를 떤다", "억지로라도 스케줄을 만들라고 재촉한다", "내 코가 석자, 알아서 잘하겠거니 하고 넘긴다"] },
  { question: "힘든 일을 겪는 친구를 위한 나만의 위로 방식은?", options: ["응원의 문자 보내기", "맛있는 저녁 사주기기", "현실적인 조언과 계획 나누", "시간이 약이다, 기다려주기"] }
];
