...
// ===== 데이터 =====
const questions = [
  { question: "혼자 있는 시간이 많은 사람을 볼 때 당신은?", options: ["외로워 보인다", "불안해 보인다", "편안해 보인다", "관심 없다"] },
  { question: "인간관계의 갈등에 처한 친구를 볼 때 당신은?", options: ["친구의 입장에서 위로한다", "같이 화를 낸다", "해결책을 제시한다", "상대방의 입장도 생각해본다"] },
  { question: "당신이 남들과 공유하고싶지 않은 감정은?", options: ["슬픔", "분노", "죄책감", "무기력"] },
  { question: "무기력에 빠진 주변 사람을 볼 때 당신은", options: ["그동안 너무 열심히 일했으니 쉴 자격이 있어!", "당장 약속을 잡고 수다를 떤다", "억지로라도 스케줄을 만들라고 재촉한다", "알아서 잘하겠거니 하고 기다린다"] },
  { question: "힘든 일을 겪는 친구를 위한 나만의 위로 방식은?", options: ["응원의 문자 보내기", "맛있는 저녁 사주기기", "현실적인 조언을 한다", "스스로 해결할 거라 믿는다"] }
];
